...
*If the presentation does not start on Binder automatically, click this button in the toolbar: <img src="./images/presentation_start_button.png" width="22" height="16">*
