...
### Tutorial
Interactive: [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/flrs/predicting_the_wind/master?urlpath=/tree/tutorial_for_self_study.ipynb) *(recommended start, may load slowly)* – Static: [PDF](https://github.com/flrs/predicting_the_wind/raw/master/tutorial_for_self_study_static.pdf) or [Jupyter Notebook](./tutorial_for_self_study.ipynb)
